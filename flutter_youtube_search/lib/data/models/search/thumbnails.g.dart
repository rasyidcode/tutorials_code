...
class _$ThumbnailsSerializer implements StructuredSerializer<Thumbnails> {
  ...
  Iterable<Object?> serialize(Serializers serializers, Thumbnails object,
    ...
    final result = <Object?>[
      'default',
      serializers.serialize(object.imgDefault,
  ...
  Thumbnails deserialize(Serializers serializers, Iterable<Object?> serialized,
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'default':
          result.imgDefault.replace(serializers.deserialize(value,
...
class _$Thumbnails extends Thumbnails {
  ...
  _$Thumbnails._(
      {required this.imgDefault, required this.medium, required this.high})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        imgDefault, 'Thumbnails', 'imgDefault');
  ...
  int get hashCode {
    return $jf(
        $jc($jc($jc(0, imgDefault.hashCode), medium.hashCode), high.hashCode));
  }

  @override
  String toString() {
    return (newBuiltValueToStringHelper('Thumbnails')
          ..add('imgDefault', imgDefault)
          ..add('medium', medium)
          ..add('high', high))
        .toString();
  }
...
class ThumbnailsBuilder implements Builder<Thumbnails, ThumbnailsBuilder> {
  ...
  ThumbnailBuilder? _imgDefault;
  ThumbnailBuilder get imgDefault =>
      _$this._imgDefault ??= new ThumbnailBuilder();
  set imgDefault(ThumbnailBuilder? imgDefault) =>
      _$this._imgDefault = imgDefault;
  ...
  ThumbnailsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _imgDefault = $v.imgDefault.toBuilder();
  ...
  _$Thumbnails build() {
    ...
    try {
      _$result = _$v ??
          new _$Thumbnails._(
              imgDefault: imgDefault.build(),
              medium: medium.build(),
              high: high.build());
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'imgDefault';
        imgDefault.build();
